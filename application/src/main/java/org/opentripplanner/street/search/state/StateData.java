...
public class StateData implements Cloneable {
    ...
    private StateData(StreetMode requestMode) {
        currentMode =
                switch (requestMode) {
                    ...
                    case NOT_SET, WALK, BIKE_RENTAL, BICYCLE_PICKUP, SCOOTER_RENTAL, CAR_RENTAL, FLEXIBLE ->
                            TraverseMode.WALK;
    ...
    public static StateData getBaseCaseStateData(StreetSearchRequest request) {
        ...
        var baseCaseDatas =
                switch (request.mode()) {
                    ...
                    case BICYCLE_PICKUP -> stateDatas
                            .stream()
                            .filter(d -> d.vehicleRentalState == RENTING_FLOATING)
                            .toList();
    ...
    private static RentalFormFactor toFormFactor(StreetMode streetMode) {
        return switch (streetMode) {
            case BICYCLE_PICKUP, BIKE_RENTAL -> RentalFormFactor.BICYCLE;

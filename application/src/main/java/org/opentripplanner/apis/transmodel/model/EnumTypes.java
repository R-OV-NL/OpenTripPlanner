...
public class EnumTypes {
    ...
    public static final GraphQLEnumType REALTIME_STATE = GraphQLEnumType
            ...
            .value("deleted",
                    ...
                    "The service journey should not be visible to the end user. Either it has been set as deleted in the real-time feed, or it has been replaced by another service journey on another pattern.")
            .build();
